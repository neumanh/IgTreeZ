...
1. Clone the repo
   ...
   ```
2. Download [IgTreeZ_1.8.3.tar.gz](https://github.com/neumanh/IgTreeZ/raw/main/IgTreeZ_1.8.3.tar.gz).  To extract the file in the local directory, use
   ```sh
   tar -zxvf IgTreeZ*.tar.gz
   ```
3. Download [IgTreeZ_1.8.3.zip](https://github.com/neumanh/IgTreeZ/raw/main/IgTreeZ_1.8.3.zip). To extract the file in the local directory, use
   ```sh
   unzip IgTreeZ*.zip
   ```
